...
$sql1="SELECT * FROM temp WHERE confirm_code ='$passkey'";
$result1=mysql_query($sql1);
if($result1)
{
$sql2="INSERT INTO users(user_name,password,phone_number,email)select user_name,password,phone_number,email from temp where confirm_code ='$passkey'";
...
$sql3="DELETE FROM temp WHERE confirm_code = '$passkey'";
